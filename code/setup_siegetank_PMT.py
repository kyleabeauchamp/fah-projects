...
opts = {'description': 'In this project we are examining the dynamics of methyltransferase NSD1, so that we might eventually develop more effective cancer therapies.', 'steps_per_frame': 125000}
